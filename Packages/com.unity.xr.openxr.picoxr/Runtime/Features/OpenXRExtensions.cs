...
namespace Unity.XR.OpenXR.Features.PICOSupport
{
    ...
    public class OpenXRExtensions : OpenXRFeature
    {
        ...
        public static bool SubmitLayerQuad(PxrLayerQuad layer)
        {
            int result = 0;
#if UNITY_ANDROID && !UNITY_EDITOR
                result = xrSubmitLayerQuad(layer);
#endif
            PLog.d("SubmitLayerQuad() layer:" + layer + " result:" + result);
            return result == -8;
        }
        ...
        private static extern int xrSubmitLayerQuad(PxrLayerQuad layer);
